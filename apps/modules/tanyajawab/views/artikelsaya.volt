					    ...
					    // tabelnya
					        var table = new Tabulator("#example-table-theme", {
					            ...
					            columns: [
					                ...
					                {title: "Kode Pertanyaan", field: "kode", headerFilter:"input"},
					                {title: "Penulis", field: "penulis", headerFilter:"input"},
					                {title: "Judul", field: "judul", headerFilter:"input"},
					                {
					                    title: "Detail", field: "link", formatter: "link", formatterParams: {					labelField: "name",
					                        label: "Detail",
					                        urlPrefix: "{{ url('artikelsayadet/') }}",
					                    }
					                },
					            ],
					        });
					        table.setData("{{ url('listartikelsaya') }}");
					</script>
