		...
		<div class="container box_1170">
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						...
						<form action="#">
							<div class="mt-10">
								<input type="number" name="first_name" placeholder="Kode Pertanyaan"
							...
							<div class="mt-10">
								<textarea id="mytextarea" class="single-textarea" placeholder="Jawaban..." onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Jawaban...'" required></textarea>
							</div>
